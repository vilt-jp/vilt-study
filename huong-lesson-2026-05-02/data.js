...
{n:18, words:["chị","muốn mua","bao nhiêu","thì","tôi","sẽ bán","cho chị","bấy nhiêu"], ans:""},
{n:19, words:["giám đốc","yêu cầu","sao","thì","tôi","làm","vậy"], ans:""},
{n:20, words:["cứ","mưa to","là","đường phố Hà Nội","bị","ngập"], ans:""},
{n:21, words:["tiếng còi xe tải","khiến","tôi","giật mình"], ans:""},
{n:22, words:["câu chuyện","của Lan","làm","tôi","cảm động","đến mức","rơi nước mắt"], ans:""},
{n:23, words:["Covid-19","đã","làm cho","ngành du lịch","tê liệt","hoàn toàn"], ans:""},
